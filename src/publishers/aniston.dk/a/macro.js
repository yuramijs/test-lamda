...
var config = {
  uuid: '0f52469d-0e93-4986-8e25-c58bf901eaaf',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/Aniston.dk_STD_930x180_skn',
        size: [
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/Aniston.dk_STD_300x250_dis',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/aniston.dk_dsk_sky1_blk',
        size: [
          [[1290, 590],[160, 600]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/aniston.dk_dsk_sky2_blk',
        size: [
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/Aniston.dk_Mobile_ROS_dis_320x320_211887',
        size: [
          [[737, 0],[]],
