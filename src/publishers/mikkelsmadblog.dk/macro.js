...
var config = {
  uuid: '8004f9ad-02de-4796-bfda-547c495086df',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/mikkelsmadblog_dsk_lb1_skn_230913',
        size: [
      ...
      adsmtag.define('def-tab-lb1', {
        path: '/5706918/mikkelsmadblog_tab1_230922',
        size: [
          [[726, 590] ,[728, 90]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/mikkelsmadblog_dsk_rec1_230914',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec2', {
        path: '/5706918/mikkelsmadblog_dsk_rec2_230915',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/mikkelsmadblog_dsk_sky1_blk_230916',
        size: [
          [[1290, 590],[160, 600]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/mikkelsmadblog_dsk_sky2_blk_230917',
        size: [
          [[1290, 590],[160, 600]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/mikkelsmadblog_mob1_230918',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/mikkelsmadblog_mob2_230919',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob3', {
        path: '/5706918/mikkelsmadblog_mob3_230920',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob4', {
        path: '/5706918/mikkelsmadblog_mob4_230921',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
