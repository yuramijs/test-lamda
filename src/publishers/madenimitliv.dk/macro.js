...
var config = {
  uuid: 'd0f1fdce-7188-44f2-935a-0deaeb1d60f1',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/Madenimitliv_930x180_skn',
        size: [
      ...
      adsmtag.define('def-tab-lb1', {
        path: '/5706918/madenimitliv_tab1_231724',
        size: [
          [[726, 590] ,[728, 90]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/madenimitliv_mob1_231716',
        size: [
          [[927, 0],[]],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/madenimitliv_mob2_231717',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160], [320, 480]]]
        ],
      ...
      adsmtag.define('def-outstream', {
        path: '/5706918/madenimitliv_dsk_outstream',
        size: [
          [[0, 0],[1, 1]]
        ],
        inview: [],
