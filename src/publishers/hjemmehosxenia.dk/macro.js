...
var config = {
  uuid: '98f267b0-ef4f-4131-b43c-039b03ff7587',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/Hjemmehosxenia_930x180_skn',
        size: [
      ...
      adsmtag.define('def-tab-lb1', {
        path: '/5706918/Hjemmehosxenia_tab1_230394',
        size: [
          [[726, 590] ,[728, 90]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/Hjemmehosxenia_dsk_rec1_229661',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec2', {
        path: '/5706918/Hjemmehosxenia_dsk_rec2_229662',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/Hjemmehosxenia_dsk_sky1_blk_229663',
        size: [
          [[1290, 590],[160, 600]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/Hjemmehosxenia_dsk_sky2_blk_229664',
        size: [
          [[1290, 590],[160, 600]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/Hjemmehosxenia_mob1_229665',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/Hjemmehosxenia_mob2_229666',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob3', {
        path: '/5706918/Hjemmehosxenia_mob3_229668',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
