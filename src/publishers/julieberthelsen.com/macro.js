...
var config = {
  uuid: '700d9232-1ede-4a38-8561-221bcb8f665c',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1-skn', {
        path: '/5706918/Blogly_JulieBerthelsen_dsk_lb1_skn_228104',
        size: [
      ...
      adsmtag.define('def-lb1-dis', {
        path: '/5706918/Blogly_JulieBerthelsen_dsk_lb1_dis',
        size: [
          [[1025, 590],[]],
          [[737, 590],[930, 180]]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/Blogly_JulieBerthelsen_dsk_sky1_blk_248198',
        size: [
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/Blogly_JulieBerthelsen_dsk_sky2_blk_248199',
        size: [
          [[1290, 590],[[160, 600], [300, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky3', {
        path: '/5706918/Blogly_JulieBerthelsen_dsk_sky3_248200',
        size: [
          [[1290, 590],[[160, 600], [300, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky4', {
        path: '/5706918/Blogly_JulieBerthelsen_dsk_sky4_248201',
        size: [
          [[1290, 590],[[160, 600], [300, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-outstream', {
        path: '/5706918/Blogly_JulieBerthelsen_dsk_outstream',
        size: [
          [[0, 0],[1, 1]]
        ],
        inview: [],
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/Blogly_JulieBerthelsen_mob1_228116',
        size: [
          [[737, 0],[]],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/Blogly_JulieBerthelsen_mob2_228117',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160], [320, 480]]]
        ],
      ...
      adsmtag.define('def-mob3', {
        path: '/5706918/Blogly_JulieBerthelsen_mob3_248207',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160], [320, 480]]]
        ],
      ...
      adsmtag.define('def-mob4', {
        path: '/5706918/Blogly_JulieBerthelsen_mob4_248208',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160], [320, 480]]]
        ],
