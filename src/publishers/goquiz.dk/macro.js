...
var config = {
  uuid: '0a8ce8a1-d9d6-4c20-bb2f-a271f0d352b2',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
      	path: '/5706918/goquiz.dk_dsk_lb1_skn',
      	size: [
      ...
      adsmtag.define('def-rec1', {
      	path: '/5706918/goquiz.dk_dsk_rec1',
      	size: [
      		[[928, 590],[300, 250]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-sky1', {
      	path: '/5706918/goquiz.dk_dsk_sky1_blk',
      	size: [
      		[[1290, 590],[160, 600]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-sky2', {
      	path: '/5706918/goquiz.dk_dsk_sky2_blk',
      	size: [
      ...
      adsmtag.define('def-rec2', {
      	path: '/5706918/goquiz.dk_dsk_rec2',
      	size: [
      		[[928, 590],[300, 250]],
      		[[0, 0],[]]
      	],
