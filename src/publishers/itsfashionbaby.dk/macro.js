...
var config = {
  uuid: 'fcfb907f-ba0e-446e-9553-b20b4d73fb86',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/itsfashionbaby.dk_dsk_lb1_skn_meg_251198',
        size: [
      ...
      adsmtag.define('def-lb3', {
        path: '/5706918/itsfashionbaby.dk_dsk_lb3_251199',
        size: [
          [[928, 590],[[930, 180],[930, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec2', {
        path: '/5706918/itsfashionbaby.dk_dsk_rec2_251201',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/itsfashionbaby.dk_mob1_251202',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/itsfashionbaby.dk_mob2_251203',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob3', {
        path: '/5706918/itsfashionbaby.dk_mob3_251204',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob4', {
        path: '/5706918/itsfashionbaby.dk_mob4_251205',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/itsfashionbaby.dk_dsk_rec1',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec3', {
        path: '/5706918/itsfashionbaby.dk_dsk_rec3',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
