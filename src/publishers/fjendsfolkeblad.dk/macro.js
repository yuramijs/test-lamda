...
var config = {
  uuid: 'cab06fed-05dd-43be-af69-f93b927ec309',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1-skn', {
      	path: '/5706918/herningfolkeblad_fjendsfolkeblad.dk_dsk_lb1_skn',
      	size: [
      ...
      adsmtag.define('def-lb6', {
      	path: '/5706918/herningfolkeblad_fjendsfolkeblad.dk_dsk_lb6',
      	size: [
      		[[928, 590] ,[930, 180]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-rec1', {
      	path: '/5706918/herningfolkeblad_fjendsfolkeblad.dk_dsk_rec1',
      	size: [
      		[[928, 590],[300, 250]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-rec2', {
      	path: '/5706918/herningfolkeblad_fjendsfolkeblad.dk_dsk_rec2',
      	size: [
      		[[928, 590],[300, 250]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-sky3', {
      	path: '/5706918/HF_fjendsfolkeblad.dk_dsk_sky3',
      	size: [
      		[[1290, 590],[160, 600]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-sky4', {
      	path: '/5706918/HF_fjendsfolkeblad.dk_dsk_sky4',
      	size: [
      		[[1290, 590],[160, 600]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-featuresplash_left', {
      	path: '/5706918/herningfolkeblad_fjendsfolkeblad.dk_featuresplash_left',
      	size: [
      		[[928, 590],[230, 60]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-featuresplash_right', {
      	path: '/5706918/herningfolkeblad_fjendsfolkeblad.dk_featuresplash_right',
      	size: [
      		[[928, 590],[230, 60]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-mob_top', {
      	path: '/5706918/herningfolkeblad_fjendsfolkeblad.dk_mob_top_320x80',
      	size: [
      		[[737, 0],[]],
      		[[0, 0],[320, 80]]
      	],
      ...
      adsmtag.define('def-bis1', {
      	path: '/5706918/HF_fjendsfolkeblad.dk_dsk_bis01',
      	size: [
      		[[928, 590],[300, 250]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-bis2', {
      	path: '/5706918/HF_fjendsfolkeblad.dk_dsk_bis02',
      	size: [
      		[[928, 590],[300, 250]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-bis3', {
      	path: '/5706918/HF_fjendsfolkeblad.dk_dsk_bis03',
      	size: [
      		[[928, 590],[300, 250]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-bis4', {
      	path: '/5706918/HF_fjendsfolkeblad.dk_dsk_bis04',
      	size: [
      		[[928, 590],[300, 250]],
      		[[0, 0],[]]
      	],
