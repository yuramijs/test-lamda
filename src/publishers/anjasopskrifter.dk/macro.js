...
var config = {
  uuid: 'd3eb1b48-124e-43a0-841d-8f2496dd2d2d',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/anjasopskrifter.dk_dsk_lb1_skn',
        size: [
          [[928, 590] ,[930, 180]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-lb2', {
        path: '/5706918/anjasopskrifter.dk_dsk_lb2',
        size: [
          [[928, 590],[930, 180]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/anjasopskrifter.dk_dsk_sky1_blk',
        size: [
          [[0, 0],[160, 600]],
        ],
        inview: [],
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/anjasopskrifter.dk_dsk_sky2_blk',
        size: [
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/anjasopskrifter.dk_mob1',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/anjasopskrifter.dk_mob2',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob3', {
        path: '/5706918/anjasopskrifter.dk_mob3',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
