...
var config = {
  uuid: 'cf1b4126-5f76-4adf-9112-c7de93d9e70a',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/girlzonly.dk_dsk_lb1_skn',
        size: [
      ...
      adsmtag.define('def-lb2', {
        path: '/5706918/girlzonly.dk_dsk_lb2',
        size: [
          [[928, 590] ,[[930, 180], [930, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-lb3', {
        path: '/5706918/girlzonly.dk_dsk_lb3',
        size: [
          [[928, 590] ,[[930, 180], [930, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/girlzonly.dk_dsk_rec1',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/girlzonly.dk_dsk_sky1_blk',
        size: [
          [[1290, 590],[160, 600]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/girlzonly.dk_dsk_sky2_blk',
        size: [
          [[1290, 590],[160, 600]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-outstream', {
        path: '/5706918/girlzonly.dk_dsk_outstream',
        size: [
          [[0, 0],[1, 1]]
        ],
        inview: [],
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/girlzonly.dk_mob1',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/girlzonly.dk_mob2',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob3', {
        path: '/5706918/girlzonly.dk_mob3',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
