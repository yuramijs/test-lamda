...
var config = {
  uuid: '0de707d6-dc09-4591-bec4-5272700aabe0',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/humor-siden.dk_dsk_lb1_skn_250333',
        size: [
      ...
      adsmtag.define('def-lb6', {
        path: '/5706918/humor-siden.dk_dsk_lb6_250334',
        size: [
          [[737, 590],[[930, 180], [930, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/humor-siden.dk_dsk_rec1',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec2', {
        path: '/5706918/humor-siden.dk_dsk_rec2_250336',
        size: [
      ...
      adsmtag.define('def-rec3', {
        path: '/5706918/humor-siden.dk_dsk_rec3',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/humor-siden.dk_mob1_250337',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
