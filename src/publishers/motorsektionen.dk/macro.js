...
var config = {
  uuid: 'db553841-a76f-458e-a60a-4fc54ec22ab0',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/Motorsektionen.dk_STD_930x180_skn',
        size: [
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/Motorsektionen.dk_STD_300x250_dis',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/motorsektionen.dk_dsk_sky1_blk',
        size: [
          [[1290, 590],[160, 600]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/motorsektionen.dk_dsk_sky2_blk',
        size: [
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/motorsektionen.dk_mob1',
        size: [
          [[927, 0],[]],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/motorsektionen.dk_mob2',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160],[320, 480]]]
        ],
