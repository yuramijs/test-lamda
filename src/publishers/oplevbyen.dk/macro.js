...
var config = {
  uuid: 'e00d7cbf-4d16-44f5-b82a-4e0f5fc67533',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/oplevbyen_dsk_lb1_skn',
        size: [
      ...
      adsmtag.define('def-rec2', {
        path: '/5706918/oplevbyen_dsk_rec2',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
