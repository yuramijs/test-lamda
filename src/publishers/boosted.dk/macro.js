...
var config = {
  uuid: '94f01f38-883a-4601-adb0-545c14c50ba6',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/Boosted.dk_dsk_lb1_skn',
        size: [
          [[928, 590], [[930, 180]]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-lb2', {
        path: '/5706918/Boosted.dk_dsk_lb2_meg',
        size: [
      ...
      adsmtag.define('def-lb3', {
        path: '/5706918/Boosted.dk_dsk_lb3',
        size: [
          [[928, 590], [[930, 180], [930, 600]]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/Boosted.dk_dsk_rec1',
        size: [
          [[928, 590], [300, 250]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-rec2', {
        path: '/5706918/Boosted.dk_dsk_rec2',
        size: [
          [[928, 590], [300, 250]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-rec3', {
        path: '/5706918/Boosted.dk_dsk_rec3',
        size: [
          [[928, 590], [300, 250]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-outstream', {
        path: '/5706918/Boosted.dk_outstream',
        size: [
          [[0, 0], [1, 1]]
        ],
        inview: [],
