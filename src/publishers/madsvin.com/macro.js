...
var config = {
  uuid: '3376fe42-e130-4afd-b9a3-a2e4a2b9473c',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/madsvin.com_dsk_lb1_skn_meg',
        size: [
      ...
      adsmtag.define('def-lb6', {
        path: '/5706918/madsvin.com_dsk_lb6',
        size: [
          [[928, 590],[[930, 180],[930, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/madsvin.com_dsk_rec1',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/madsvin.com_dsk_sky1_blk',
        size: [
          [[1290, 590],[160, 600]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/madsvin.com_dsk_sky2_blk',
        size: [
          [[1290, 590],[160, 600]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky3', {
        path: '/5706918/madsvin.com_dsk_sky3_blk',
        size: [
          [[1290, 590],[160, 600]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky4', {
        path: '/5706918/madsvin.com_dsk_sky4_blk',
        size: [
      ...
      adsmtag.define('def-sky5', {
        path: '/5706918/madsvin.com_dsk_sky5_blk',
        size: [
          [[1290, 590],[[160, 600], [300, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky6', {
        path: '/5706918/madsvin.com_dsk_sky6_blk',
        size: [
          [[1290, 590],[[160, 600], [300, 600]]],
          [[0, 0],[]]
        ],
