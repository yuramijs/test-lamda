...
var config = {
  uuid: 'aab46bad-b6fe-4f4d-b944-c08cd8cf27f0',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/Modesektionen.dk_STD_930x180_skn',
        size: [
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/Modesektionen.dk_STD_300x250_dis',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/modesektionen.dk_dsk_sky1_blk',
        size: [
          [[1290, 590],[160, 600]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/modesektionen.dk_dsk_sky2_blk',
        size: [
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/Modesektionen.dk_mob1',
        size: [
          [[737, 0],[]],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/modesektionen.dk_mob2',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160],[320, 480]]]
        ],
