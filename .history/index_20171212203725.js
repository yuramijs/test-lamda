...
const getOutput = file => {
    if(file === 'css.css') {
        return `/home/q/using-aws-sdk/aniston/aniston/css/${file}`;
    }
    else if(file === 'skin.js') {
        return `/home/q/using-aws-sdk/aniston/aniston/mnemonics/${file}`;
    }
    else {
        return `/home/q/using-aws-sdk/aniston/aniston/${file}`;
    }
};
