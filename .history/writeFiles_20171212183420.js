...
const listObjects = async (function (dir) {
    ...
    // const result = await (fs.readFile(__dirname + '/aniston/macro.js', 'utf8'));
    // console.log(result);

    fs.readFile(__dirname + '/aniston/macro.js', 'utf8', (d) =>{
        console.log(fs.readFile(__dirname + '/aniston/macro.js', 'utf8'))
    })
