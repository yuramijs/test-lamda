...
var config = {
  uuid: '12ffb2ef-7b2d-417d-b06b-c5b9075301fb',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/Filmz_930x180_skn',
        size: [
          [[928, 590],[930, 180]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec2', {
        path: '/5706918/Filmz_rec2_226174',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec3', {
        path: '/5706918/Filmz_rec3_226367',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
