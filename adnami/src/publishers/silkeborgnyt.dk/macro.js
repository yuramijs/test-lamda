...
var config = {
  uuid: '85c0d4c5-5c2c-4d6d-a771-b2256c784685',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1-skn', {
        path: '/5706918/Blogly_Signeeflund.dk_dsk_lb1_skn',
        size: [
      ...
      adsmtag.define('def-lb1-dis', {
        path: '/5706918/Blogly_Signeeflund.dk_dsk_lb1_dis',
        size: [
          [[1025, 590],[]],
          [[737, 590],[930, 180]]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/Blogly_Signeeflund.dk_dsk_sky1_blk_227086',
        size: [
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/Blogly_Signeeflund.dk_dsk_sky2_blk_227088',
        size: [
          [[1290, 590],[[160, 600], [300, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky3', {
        path: '/5706918/Blogly_Signeeflund.dk_dsk_sky3_227087',
        size: [
          [[1290, 590],[[160, 600], [300, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky4', {
        path: '/5706918/Blogly_Signeeflund.dk_dsk_sky4_227095',
        size: [
          [[1290, 590],[[160, 600], [300, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-outstream', {
        path: '/5706918/Blogly_Signeeflund.dk_dsk_outstream',
        size: [
          [[0, 0],[1, 1]]
        ],
        inview: [],
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/Blogly_Signeeflund.dk_mob1',
        size: [
          [[737, 0],[]],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/Blogly_Signeeflund.dk_mob2_227104',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160], [320, 480]]]
        ],
      ...
      adsmtag.define('def-mob3', {
        path: '/5706918/Blogly_Signeeflund.dk_mob3_227105',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160], [320, 480]]]
        ],
      ...
      adsmtag.define('def-mob4', {
        path: '/5706918/Blogly_Signeeflund.dk_mob4_227106',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160], [320, 480]]]
        ],
