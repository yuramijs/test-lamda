...
var config = {
  uuid: 'a52a7408-6cb8-46b3-bc89-26b74b48173a',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1-skn', {
        path: '/5706918/2014_Billetlugen_std_930x180_top',
        size: [
          [[928, 590] ,[930, 180]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-lb1-dis', {
        path: '/5706918/Billetlugen_dsk_lb1_dis',
        size: [
          [[928, 590] ,[930, 180]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/2014_Billetlugen_std_300x250_Content1',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec2', {
        path: '/5706918/2014_Billetlugen_std_300x250_Content2',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec3', {
        path: '/5706918/2014_Billetlugen_std_300x250_Content3',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-tab-lb1', {
        path: '/5706918/2014_Billetlugen_Tablet_930x180_Top',
        size: [
          [[756, 590] ,[930, 180]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-tab-lb2', {
        path: '/5706918/2014_Billetlugen_Tablet_930x180_Content1',
        size: [
          [[756, 590] ,[930, 180]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-tab-lb3', {
        path: '/5706918/2014_Billetlugen_Tablet_930x180_Content2',
        size: [
          [[756, 590] ,[930, 180]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/2014_Billetlugen_mobile_300x250_Top',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/2014_Billetlugen_mobile_300x250_Content1',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob3', {
        path: '/5706918/2014_Billetlugen_mobile_300x250_Content2',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
