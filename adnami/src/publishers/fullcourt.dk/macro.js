...
var config = {
  uuid: 'cd4e22ce-d35e-406f-bcaf-1120cb7ddaed',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/fullcourt.dk_dsk_lb1_skn',
        size: [
          [[928, 590] ,[930, 180]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/fullcourt.dk_dsk_rec1',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec2', {
        path: '/5706918/fullcourt.dk_dsk_rec2',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
        ...
        path: '/5706918/fullcourt.dk_dsk_rec3',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/fullcourt.dk_dsk_sky1_blk',
        size: [
          [[1290, 590],[160, 600]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/fullcourt.dk_dsk_sky2_blk',
        size: [
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/fullcourt.dk_mob1',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/fullcourt.dk_mob2',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob3', {
        path: '/5706918/fullcourt.dk_mob3',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob4', {
        path: '/5706918/fullcourt.dk_mob4',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-mob5', {
        path: '/5706918/fullcourt.dk_mob5',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160]]]
        ],
      ...
      adsmtag.define('def-outstream', {
        path: '/5706918/fullcourt.dk_outstream',
        size: [
          [[0, 0],[1, 1]]
        ],
        inview: [],
