...
var config = {
  uuid: '0ac1e52c-f664-46b4-947a-75f73fcafc85',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1-skn', {
        path: '/5706918/regitzes.dk_dsk_lb1_skn',
        size: [
      ...
      adsmtag.define('def-lb1-dis', {
        path: '/5706918/regitzes.dk_dsk_lb1_dis',
        size: [
          [[1025, 590],[]],
          [[737, 590],[930, 180]]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/regitzes.dk_dsk_sky1_blk',
        size: [
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/regitzes.dk_dsk_sky2_blk',
        size: [
          [[1290, 590],[[160, 600], [300, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky3', {
        path: '/5706918/regitzes.dk_dsk_sky3_blk',
        size: [
          [[1290, 590],[[160, 600], [300, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky4', {
        path: '/5706918/regitzes.dk_dsk_sky4_blk',
        size: [
          [[1290, 590],[[160, 600], [300, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-outstream', {
        path: '/5706918/regitzes.dk_outstream',
        size: [
          [[0, 0],[1, 1]]
        ],
        inview: [],
