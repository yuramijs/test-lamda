...
var config = {
  uuid: 'ecfc3a1c-a538-43d3-b4c4-ff17a1725622',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/Babybusiness.dk_dsk_lb1_skn',
        size: [
      ...
      adsmtag.define('def-rec2', {
        path: '/5706918/Babybusiness.dk_dsk_rec2',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec3', {
        path: '/5706918/Babybusiness.dk_dsk_rec3',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/Babybusiness.dk_mob1',
        size: [
          [[927, 0],[]],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/Babybusiness.dk_mob2',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160], [320, 480]]]
        ],
      ...
      adsmtag.define('def-mob3', {
        path: '/5706918/Babybusiness.dk_mob3',
        size: [
          [[927, 0],[]],
          [[0, 0],[[320, 320],[320, 160], [320, 480]]]
        ],
