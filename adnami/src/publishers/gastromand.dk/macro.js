...
var config = {
  uuid: 'ade74c9c-3e33-40d9-afa7-d5ecc7afad71',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
      	path: '/5706918/gastromand.dk_dsk_lb1_skn',
      	size: [
      		[[928, 590] ,[930, 180]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-rec1', {
      	path: '/5706918/gastromand.dk_dsk_rec1',
      	size: [
      		[[928, 590],[300, 250]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-rec2', {
      	path: '/5706918/gastromand.dk_dsk_rec2',
      	size: [
      		[[928, 590],[300, 250]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-rec3', {
      	path: '/5706918/gastromand.dk_dsk_rec3',
      	size: [
      		[[928, 590],[300, 250]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-mob1', {
      	path: '/5706918/gastromand.dk_mob1',
      	size: [
      		[[927, 0],[]],
      		[[0, 0],[[320, 320],[320, 160]]]
      	],
      ...
      adsmtag.define('def-mob2', {
      	path: '/5706918/gastromand.dk_mob2',
      	size: [
      		[[927, 0],[]],
      		[[0, 0],[[320, 320],[320, 160]]]
      	],
      ...
      adsmtag.define('def-mob3', {
      	path: '/5706918/gastromand.dk_mob3',
      	size: [
      		[[927, 0],[]],
      		[[0, 0],[[320, 320],[320, 160]]]
      	],
      ...
      adsmtag.define('def-mob4', {
      	path: '/5706918/gastromand.dk_mob4',
      	size: [
      		[[927, 0],[]],
      		[[0, 0],[[320, 320],[320, 160]]]
      	],
      ...
      adsmtag.define('def-tab-lb1', {
      	path: '/5706918/gastromand.dk_tab_lb1',
      	size: [
      		[[756, 590],[930, 180]],
      		[[0, 0],[]]
      	],
      ...
      adsmtag.define('def-outstream', {
      	path: '/5706918/gastromand.dk_dsk_outstream',
      	size: [
      		[[0, 0],[1, 1]]
      	],
      	inview: [],
