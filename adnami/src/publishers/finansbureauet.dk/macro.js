...
var config = {
  uuid: '57a1145b-4d0b-4d7b-a461-242083d15102',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/Finansbureauet.dk_STD_930x180_skn',
        size: [
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/Finansbureauet.dk_STD_300x250_dis',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/finansbureauet.dk_dsk_sky1_blk',
        size: [
          [[1290, 590],[160, 600]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/finansbureauet.dk_dsk_sky2_blk',
        size: [
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/Finansbureauet.dk_mob1',
        size: [
          [[737, 0],[]],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/finansbureauet.dk_mob2',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160], [320, 480]]]
        ],
