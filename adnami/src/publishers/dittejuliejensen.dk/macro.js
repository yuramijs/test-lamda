...
var config = {
  uuid: '86d8ea21-5a60-4ac3-a315-1d0ec2a57292',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1-skn', {
        path: '/5706918/dittejuliejensen.dk_dsk_lb1_skn',
        size: [
      ...
      adsmtag.define('def-lb1-dis', {
        path: '/5706918/dittejuliejensen.dk_dsk_lb1_dis',
        size: [
          [[1025, 590],[]],
          [[737, 590],[930, 180]]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/dittejuliejensen.dk_dsk_sky1_blk',
        size: [
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/dittejuliejensen.dk_dsk_sky2_blk',
        size: [
          [[1290, 590],[[160, 600], [300, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky3', {
        path: '/5706918/dittejuliejensen.dk_dsk_sky3',
        size: [
          [[1290, 590],[[160, 600], [300, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-sky4', {
        path: '/5706918/dittejuliejensen.dk_dsk_sky4',
        size: [
          [[1290, 590],[[160, 600], [300, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-outstream', {
        path: '/5706918/dittejuliejensen.dk_outstream',
        size: [
          [[0, 0],[1, 1]]
        ],
        inview: [],
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/dittejuliejensen.dk_mob1',
        size: [
          [[737, 0],[]],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/dittejuliejensen.dk_mob2',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160], [320, 480]]]
        ],
      ...
      adsmtag.define('def-mob3', {
        path: '/5706918/dittejuliejensen.dk_mob3',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160], [320, 480]]]
        ],
      ...
      adsmtag.define('def-mob4', {
        path: '/5706918/dittejuliejensen.dk_mob4',
        size: [
          [[737, 0],[]],
          [[0, 0],[[320, 320],[320, 160], [320, 480]]]
        ],
