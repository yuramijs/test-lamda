...
var config = {
  uuid: '4175b8af-dba8-4fb9-8e5d-6e3a90dbb970',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/racemag.dk_dsk_lb1_skn',
        size: [
      ...
      adsmtag.define('def-lb3', {
        path: '/5706918/racemag.dk_dsk_lb3',
        size: [
          [[928, 590] ,[[930, 180], [930, 600]]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/racemag.dk_dsk_rec1',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec2', {
        path: '/5706918/racemag.dk_dsk_rec2',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
      ...
      adsmtag.define('def-rec3', {
        path: '/5706918/racemag.dk_dsk_rec3',
        size: [
          [[928, 590],[300, 250]],
          [[0, 0],[]]
        ],
