...
var config = {
  uuid: 'ce61fa3a-b399-43d6-bf41-8a3a1066e4cb',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/feedt.dk_dsk_lb1_skn_meg',
        size: [
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/feedt.dk_dsk_rec1',
        size: [
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/feedt.dk_dsk_sky1_blk',
        size: [
          [[1290, 590], [160, 600]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/feedt.dk_dsk_sky2_blk',
        size: [
          [[1290, 590], [160, 600]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-outstream', {
        path: '/5706918/feedt.dk_outstream',
        size: [
          [[0, 0], [1, 1]]
        ],
        inview: [],
