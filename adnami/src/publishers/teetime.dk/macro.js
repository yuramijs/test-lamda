...
var config = {
  uuid: '36ab8c13-cecd-43c5-9892-a31524f3db09',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/Teetime.dk_dsk_lb1_skn',
        size: [
      ...
      adsmtag.define('def-lb2', {
        path: '/5706918/Teetime.dk_dsk_lb2',
        size: [
          [[928, 590], [[930, 180], [930, 600]]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-lb3', {
        path: '/5706918/Teetime.dk_dsk_lb3_mega',
        size: [
          [[928, 590], [930, 180]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-lb4', {
        path: '/5706918/Teetime.dk_dsk_lb4',
        size: [
          [[928, 590], [930, 180]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-lb5', {
        path: '/5706918/Teetime.dk_dsk_lb5',
        size: [
          [[928, 590], [930, 180]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/Teetime.dk_dsk_rec1',
        size: [
          [[928, 590], [300, 250]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-rec2', {
        path: '/5706918/Teetime.dk_dsk_rec2',
        size: [
          [[928, 590], [300, 250]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-rec3', {
        path: '/5706918/Teetime.dk_dsk_rec3',
        size: [
          [[928, 590], [300, 250]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-rec4', {
        path: '/5706918/Teetime.dk_dsk_rec4',
        size: [
          [[928, 590], [300, 250]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-sky1', {
        path: '/5706918/Teetime.dk_dsk_sky1',
        size: [
          [[1290, 590], [160, 600]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-sky2', {
        path: '/5706918/Teetime.dk_dsk_sky2',
        size: [
          [[1290, 590], [160, 600]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-sky3', {
        path: '/5706918/Teetime.dk_dsk_sky3',
        size: [
          [[1290, 590], [160, 600]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-sky4', {
        path: '/5706918/Teetime.dk_dsk_sky4',
        size: [
          [[1290, 590], [160, 600]],
          [[0, 0], []]
        ],
      ...
      adsmtag.define('def-outstream', {
        path: '/5706918/Teetime.dk_outstream',
        size: [
          [[0, 0], [1, 1]]
        ],
        inview: [],
      ...
      adsmtag.define('def-tab-lb1', {
        path: '/5706918/Teetime.dk_tab_lb1',
        size: [
          [[737, 590], [930, 180]]
        ],
        inview: [],
