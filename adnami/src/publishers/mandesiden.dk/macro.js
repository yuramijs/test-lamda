...
var config = {
  uuid: 'a08be24e-86b9-4969-9469-971ea4b1ce3a',
  default: function() {
    ...
    cmd.push(function () {
      ...
      adsmtag.define('def-lb1', {
        path: '/5706918/mandesiden.dk_dsk_lb1_skn',
        size: [
          [[1025, 0], [[930, 180], [930, 600], [930, 360]]],
        ],
        inview: [],
        refresh: 0,
        dependencies: [],
      ...
      adsmtag.define('def-lb2', {
        path: '/5706918/mandesiden.dk_dsk_lb2',
        size: [
          [[1025, 0], [[930, 180], [930, 600], [930, 360]]],
        ],
        inview: [],
      ...
      adsmtag.define('def-rec1', {
        path: '/5706918/mandesiden.dk_dsk_rec1',
        size: [
          [[768, 0], [300, 250]],
        ],
        inview: [],
      ...
      adsmtag.define('def-rec2', {
        path: '/5706918/mandesiden.dk_dsk_rec2',
        size: [
          [[768, 0], [300, 250]],
        ],
        inview: [],
      ...
      adsmtag.define('def-mob1', {
        path: '/5706918/mandesiden.dk_mob1',
        size: [
          [[768, 0], []],
      ...
      adsmtag.define('def-mob2', {
        path: '/5706918/mandesiden.dk_mob2',
        size: [
          [[768, 0], []],
          [[0, 0], [[300, 250], [320, 50], [320, 160], [320, 320]]],
        ],
      ...
      adsmtag.define('def-mob3', {
        path: '/5706918/mandesiden.dk_mob3',
        size: [
          [[768, 0], []],
          [[0, 0], [[300, 250], [320, 50], [320, 160], [320, 320]]],
        ],
      ...
      adsmtag.define('def-mob4', {
        path: '/5706918/mandesiden.dk_mob4',
        size: [
          [[768, 0], []],
          [[0, 0], [[300, 250], [320, 50], [320, 160], [320, 320]]],
        ],
      ...
      adsmtag.define('def-tab-lb1', {
        path: '/5706918/mandesiden.dk_tab_lb1',
        size: [
          [[1025, 0], []],
      ...
      adsmtag.define('def-tab-tab2', {
        path: '/5706918/mandesiden.dk_tab_tab2',
        size: [
          [[1025, 0], []],
          [[768, 0], [[930, 180], [728, 90]]],
          [[0, 0], []],
      ...
      adsmtag.display('cncpt-tab-tab2', 'def-tab-tab2');
    });
